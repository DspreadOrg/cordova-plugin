...
//    module.exports = posPlug;
               ...
               function Dspread_pos_plugin() {};
               Dspread_pos_plugin.prototype.scanQPos2Mode = function (success,fail,option) {
                   exec(success, fail, 'dspread_pos_plugin', 'scanQPos2Mode', option);
               };
               
               var posPlugin = new Dspread_pos_plugin();
