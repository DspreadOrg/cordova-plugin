...
var posPlug = {
	...
	connectBluetoothDevice:function(success,fail,isPaired,bluetoothAddress){
		  exec(success,fail,"dspread_pos_plugin","connectBluetoothDevice",[isPaired,bluetoothAddress]);
  	},
